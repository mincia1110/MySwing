...
- 긴 영상, 여러 번의 스윙, 배팅 연습 세션, 전체 경기 클립은 지원하지 않습니다.
- MySwing은 현재 긴 영상에서 스윙 구간을 자동 탐지하거나 추출하지 않습니다.
- 업로드 전에 외부 도구로 한 번의 스윙만 남기도록 잘라 주세요. 앱 내 trimming UI는 현재 범위에 포함되지 않습니다.
